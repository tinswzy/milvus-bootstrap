# Milvus Enterprise Admin WebUI — 资源解耦方案与原型

> 围绕 **Milvus 3.0 "switch MQ"** 诉求，论证如何把"底层资源的安装编排"与"Milvus 运行时连线"两件事解耦，并给出三种落地方案的对比、各自的实施细则，以及一套轻量管理控制台（Milvus Enterprise Admin WebUI）的可点击原型。
...
| [docs/03-方案三_enterprise-admin-webui.md](docs/03-方案三_enterprise-admin-webui.md) | 研发 / 产品 | toB 厂商最佳实践对标 + Milvus Enterprise Admin WebUI 原型说明 + Python/Web 架构 |
